;The following problem shows more complex properties of the terraformer
;This displays the terraformer being both fixed and recharged
(define (problem problem4)
    ...
    (:init
        ...
        ;Which locations are themselves (used to stop 1 shield being used 3 times to turn on the planetary shield)
        ;Row 1
        (same l11,l11)
        (same l12,l12)
        (same l13,l13)
